 ...
 * Changed by Mukundan on 5/28/14.
 */
        ...
        void addAIMLSets() {
            ...
            try {
                ...
                if (context.getAssets().list(MagicStrings.sets_path).length > 0) {
                    String[] listOfFiles = context.getAssets().list(MagicStrings.sets_path);
            ...
            void addAIMLMaps() {
                ...
                try {
                    ...
                    if (context.getAssets().list(MagicStrings.maps_path).length > 0) {
                        String[] listOfFiles = context.getAssets().list(MagicStrings.maps_path);
