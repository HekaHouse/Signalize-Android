 ...
 */
package ppc.signalize.mira.body.parts.skeleton.text;
 ...
 */
public class MiraWordList
{
    private String [] words;

    private String source;

    public MiraWordList(String source)
    {
        this.source = source.toLowerCase();
        words = new String[] {source.toLowerCase()}; //this.source.split("\\s");
