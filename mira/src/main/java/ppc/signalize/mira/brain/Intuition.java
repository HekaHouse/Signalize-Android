...
import ppc.signalize.mira.nervous.concurrent.ModelingRunner;
...
public class Intuition implements Runnable {
    ...
    public Intuition(boolean eval, Voice _world) {
    ...
    public static void extract_training(Voice _world) {
    ...
    public static void init(Voice _world) {
    ...
    public static void train(Voice _world, String type) throws IOException {
    ...
    public static void evaluate(Voice _world, String type) throws IOException {
        if (mRepositories.size() < 1)
            init(_world);
