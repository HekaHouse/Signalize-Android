...
/**
 * Helps execute {@link root.gast.speech.voiceaction.VoiceAction}s and say their responses and prompts.
...
public class VoiceActionExecutor
{
    ...
    /**
     * execute the current active {@link root.gast.speech.voiceaction.VoiceAction} again speaking
     * extraPrompt before
     */
