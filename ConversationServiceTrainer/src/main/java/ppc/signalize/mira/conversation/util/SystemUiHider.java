package ppc.signalize.mira.conversation.util;
 ...
 * {@link #getInstance} will return a {@link ppc.signalize.mira.conversation.util.SystemUiHiderHoneycomb} instance,
 * while on older devices {@link #getInstance} will return a
 * {@link ppc.signalize.mira.conversation.util.SystemUiHiderBase} instance.
 * <p>
...
public abstract class SystemUiHider {
    ...
    /**
     * Creates and returns an instance of {@link ppc.signalize.mira.conversation.util.SystemUiHider} that is
     * appropriate for this device. The object will be either a
     * {@link ppc.signalize.mira.conversation.util.SystemUiHiderBase} or {@link ppc.signalize.mira.conversation.util.SystemUiHiderHoneycomb} depending on
     * the device.
     *
